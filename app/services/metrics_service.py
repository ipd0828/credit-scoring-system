...
class MetricsService:
    ...
    async def get_prometheus_metrics(self) -> str:
        ...
        try:
            ...
            logger.error("Не удалось получить метрики Prometheus", error=str(e), exc_info=True)
    ...
    async def get_model_performance_metrics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            raise RuntimeError(f"Не удалось получить метрики производительности модели: {str(e)}")
