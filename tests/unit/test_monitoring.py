...
class TestModelMonitoring:
    ...
    def test_detect_data_drift_no_drift(self, temp_model_file, temp_reference_data_file, sample_processed_data):
    ...
    def test_generate_monitoring_report(self, temp_model_file, temp_reference_data_file, sample_processed_data):
        ...
        result = monitor.generate_monitoring_report(sample_processed_data, X_test, y_test, feature_columns)
